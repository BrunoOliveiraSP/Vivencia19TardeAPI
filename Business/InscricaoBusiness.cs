...
namespace Vivencia19TardeAPI.Business
{
    public class InscricaoBusiness
    {
        ...
        public void Inserir(Models.TbInscricao inscricao )
        {
            ...
            if (inscricao.NrResidenciaEndereco == 0 || inscricao.NrResidenciaEndereco == null)
            {
           ...
           if (inscricao.VlRenda == 0 || inscricao.VlRenda == null)
           {
               throw new ArgumentException("Você esqueceu de colocar a renda media do candidato!");
           }
           if (inscricao.QtMoramCasa == 0 || inscricao.QtMoramCasa == null)
           {
