...
namespace Vivencia19TardeAPI.Business
{
    public class InscricaoBusiness
    {
        ...
        public void Inserir(Models.TbInscricao inscricao )
        {
            ...
            bool tel1Valido = StringExtension.IsValidPhone(inscricao.DsTelefone);
            bool tel2Valido = StringExtension.IsValidPhone(inscricao.DsTelefone2);
        ...
        public List<Models.TbInscricao> ConsultarAnoLetivoLista(int id)
        {
            if (id == 0)
            {
                throw new ArgumentException("Informe o ano letivo.");
